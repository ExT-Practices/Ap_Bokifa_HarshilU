...
const AddBlog = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      if (res.data?.image) {
        ...
        toast.success("Article cover image uploaded!");
      }
    } catch (err) {
      console.error("Upload error:", err);
      toast.error("Failed to upload article cover.");
    } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(error);
      toast.error(error.response?.data?.message || "Failed to add blog article.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
        <div className="flex items-center gap-3 border-b border-slate-100 pb-6 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-extrabold text-slate-900">Publish New Article</h1>
            <p className="text-xs text-slate-500 mt-0.5">Create blog posts, reading tips, or news updates</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="md:col-span-2 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. 10 Reading Habits for 2026"
                  required
          ...
          <div className="border-t border-slate-100 pt-6 flex justify-end gap-3">
            ...
            <button
              ...
              className="px-8 py-3 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 shadow-md shadow-purple-500/25 transition disabled:opacity-50"
            >
